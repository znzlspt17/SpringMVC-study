					...
					<div id="join-form" class="join-form margin-large">
						<dl class="join-form-row">
							...
							<dd class="join-form-data">
								<input type="text" name="uid" /> <input id="btnCheckUid"
						...
						<dl class="join-form-row birthday">
							...
							<dd class="join-form-data">
								<span> <input type="text" id="year" />년 <input
									type="text" id="month" />월 <input type="text" id="day" />일 <input
						...
						<dl class="join-form-row">
							...
							<dd class="join-form-data habit">
								<input type="checkbox" name="habit" id="music" /><label
									...
									id="movie" /><label for="movie">영화</label> <input
									type="checkbox" name="habit" id="trip" /><label for="trip">여행</label>
							</dd>
						</dl>
					</div>
					<div id="buttonLine">
